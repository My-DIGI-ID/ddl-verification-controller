...
public class VerificationRequestServiceTest {
    ...
    public void CreateVerificationRequest_VerificationRepositorySave_WasCalledOnce() {
        Mockito.when(verificationRepository.save(Mockito.isA(VerificationRequest.class))).thenReturn(new VerificationRequest());
        Mockito.when(verificationRequestMapper.verificationRequestToVerificationRequestDTO(Mockito.isA(VerificationRequest.class)))
