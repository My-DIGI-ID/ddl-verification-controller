...
public class VerifierController {
   ...
   *         already exist.
   */
  @PostMapping(name="/init", consumes="application/json", produces = "application/json")
   ...
   */
  @PostMapping(name="/invalidate", consumes="application/json", produces = "application/json")
